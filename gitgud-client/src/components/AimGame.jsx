      ...
      <div className="aim-wrapper">
        ...
        <div className="aim-settings">
          ...
          <div className="aim-controls">
            <button className={`aim-option-btn ${crosshairType === "dotCross" ? "active" : ""}`} onClick={() => setCrosshairType("dotCross")}>✚</button>
            <button className={`aim-option-btn ${crosshairType === "plus"     ? "active" : ""}`} onClick={() => setCrosshairType("plus")}>＋</button>
            <button className={`aim-option-btn ${crosshairType === "x"        ? "active" : ""}`} onClick={() => setCrosshairType("x")}>✖</button>
            <button className={`aim-option-btn ${crosshairType === "dot"      ? "active" : ""}`} onClick={() => setCrosshairType("dot")}>●</button>

            <button className={`aim-option-btn ${crosshairColor === "#000000" ? "active" : ""}`} onClick={() => setCrosshairColor("#000000")}>Black</button>
            <button className={`aim-option-btn ${crosshairColor === "#ffffff" ? "active" : ""}`} onClick={() => setCrosshairColor("#ffffff")}>White</button>
            <button className={`aim-option-btn ${crosshairColor === "#00ff00" ? "active" : ""}`} onClick={() => setCrosshairColor("#00ff00")}>Green</button>
            <button className={`aim-option-btn ${crosshairColor === "#0000ff" ? "active" : ""}`} onClick={() => setCrosshairColor("#0000ff")}>Blue</button>
          </div>
        </div>
